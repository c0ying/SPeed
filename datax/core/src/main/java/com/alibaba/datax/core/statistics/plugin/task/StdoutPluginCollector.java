...
public class StdoutPluginCollector extends AbstractTaskPluginCollector {
    ...
    protected AtomicInteger maxLogNum = new AtomicInteger(0);

    protected AtomicInteger currentLogNum = new AtomicInteger(0);
    ...
    protected String formatDirty(final Record dirty, final Throwable t,
                               final String msg) {
