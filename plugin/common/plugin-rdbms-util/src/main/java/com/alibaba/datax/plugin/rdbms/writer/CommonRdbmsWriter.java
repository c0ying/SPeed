...
//            OriginalConfPretreatmentUtil.DATABASE_TYPE = this.dataBaseType;
        ...
        public void init(Configuration originalConfig) {
        	dataBaseType = DataBaseTypeIdentification.getWriterJobDataBaseType(originalConfig);
        ...
        public void writerPreCheck(Configuration originalConfig) {
            /*检查PreSql跟PostSql语句*/
            prePostSqlValid(originalConfig);
            //@cyh 暂不需要
            /*检查insert 跟delete权限*/
//            privilegeValid(originalConfig);
        }

        public void prePostSqlValid(Configuration originalConfig) {
            /*检查PreSql跟PostSql语句*/
            WriterUtil.preCheckPrePareSQL(originalConfig, this.dataBaseType);
            WriterUtil.preCheckPostSQL(originalConfig, this.dataBaseType);
        }
    ...
    public static class Task {
        ...
        protected TaskGroupContext taskContext;
        ...
        public void init(Configuration writerSliceConfig) {
            ...
            if (dataSource != null) {
				String dbTypeStr = ((DruidDataSource)dataSource).getDbType();
				dataBaseType = DataBaseType.dbNameOf(dbTypeStr);
			}else {
				dataBaseType = DataBaseTypeIdentification.getJdbcDataBaseType(jdbcUrl);
			}
