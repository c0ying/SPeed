...
//    }
    ...
    public static void simplifyConf(Configuration originalConfig, DataBaseType dataBaseType) {
        ...
        for (int i = 0, len = connections.size(); i < len; i++) {
            ...
            List<String> expandedTables = TableExpandUtil
                    .expandTableConf(dataBaseType, tables);
    ...
    public static void dealColumnConf(Configuration originalConfig, ConnectionFactory connectionFactory, String oneTable, DataBaseType dataBaseType) {
        ...
        if (null == userConfiguredColumns || userConfiguredColumns.isEmpty()) {
            ...
            if (isPreCheck){
                allColumns = DBUtil.getTableColumnsByConn(dataBaseType,connectionFactory.getConnecttionWithoutRetry(), oneTable, connectionFactory.getConnectionInfo());
            }else{
                allColumns = DBUtil.getTableColumnsByConn(dataBaseType,connectionFactory.getConnecttion(), oneTable, connectionFactory.getConnectionInfo());
            }
