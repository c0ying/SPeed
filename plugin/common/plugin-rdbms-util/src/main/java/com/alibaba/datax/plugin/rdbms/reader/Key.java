...
public final class Key {
    ...
    public final static String READER_CHANNEL = "readerChannel";
    ...
    public final static String SPLIT_LOWER = "splitLower";
    public final static String SPLIT_LOWER_EQ = "splitLowerEq";
    public final static String SPLIT_UPPER = "splitUpper";
    public final static String SPLIT_UPPER_EQ = "splitUpperEq";
