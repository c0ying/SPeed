package com.jingxin.datax.plugin.reader.reader;
...
//            DATABASE_TYPE = DataBaseTypeIdentification.getJobDataBaseType(originalConfig);
...
//            init();
    ...
    public static class Task extends Reader.Task {
        ...
        public void init() {
            ...
            this.commonRdbmsReaderTask = new CommonRdbmsReader.Task(super.getTaskGroupId(), super.getTaskId());
            this.commonRdbmsReaderTask.setTaskContext(taskGroupContext);
